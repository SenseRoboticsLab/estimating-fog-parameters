...
public:
    ...
    // 构造函数
    System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor, const bool bUseViewer = true, const string &strPhotometricSettings = "NA");
...
private:
    ...
    // Input sensor
    eSensor mSensor;                // 传感器类型MONOCULAR,STEREO,RGBD
    ...
    // Fog Estimator. It estimates fog parameters, namely the scattering coefficient beta and the atmospheric light A.
