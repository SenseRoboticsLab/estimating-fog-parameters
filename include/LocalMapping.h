...
public:
    ...
    void InsertKeyFrame(KeyFrame* pKF);             // 向缓冲队列mlNewKeyFrames内插入关键帧
    ...
    int KeyframesInQueue(){                         // 查询缓冲队列mlNewKeyFrames内关键帧个数
...
protected:
    ...
    bool mbAcceptKeyFrames;                         // LocalMapping线程是否愿意接收Tracking线程传来的新关键帧
